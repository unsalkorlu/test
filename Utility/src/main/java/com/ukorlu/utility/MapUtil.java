...
public class MapUtil {
    ...
    public static HashMap<String, Integer> sortHashMapWithStringKeysAndIntegerValues(Map<String, Integer> input, boolean descending) {
        Map<String, Integer> tempMap = new HashMap<>();
        for (String wsState : input.keySet()) {
            tempMap.put(wsState, input.get(wsState));
        }
    ...
    public static HashMap<String, Long> sortHashMapWithStringKeysAndLongValues(Map<String, Long> input, boolean descending) {
    ...
    public static HashMap<String, Integer> sortHashMapWithIntegerValues(Map<String, Integer> input, boolean descending) {
        Map<String, Integer> tempMap = new HashMap<>();
        for (String wsState : input.keySet()) {
            tempMap.put(wsState, input.get(wsState));
        }
